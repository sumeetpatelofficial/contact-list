...
const Banner = () => {
  return (
    <div className="relative bg-white overflow-hidden">
            ...
            <div className="sm:text-center lg:text-left">
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                ...
                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <a
                    href="#"
                    className="w-full flex items-center justify-center px-8 py-3 border border-blue text-base font-medium rounded-md text-blue bg-indigo-100 hover:bg-indigo-200 md:py-4 md:text-lg md:px-10"
                  >
                    Live demo
                  </a>
                </div>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 xl:w-auto xl:inset-y-0">
        <img
